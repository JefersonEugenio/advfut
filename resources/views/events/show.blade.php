    ...
    <div class="row">
        ...
        <div id="info-container" class="col-md-4">
            ...
            @if(auth()->check())
                ...
                @else
                    <p class="already-joined-msg">Esse time já está participando deste jogo contra o adversário: {{ $agenda->equipeAdversario->clube }}</p>
                @endif
            @else
                <p class="login-msg">Para confirmar a participação, -> <a href="/login">faça login</a> <- na sua conta.</p>
            @endif
        </div>

        <div id="mapa" class="col-md-4">
            <h3>Localização</h3>    
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyBGXD26QCwEwOi2kaiDjFcnZ6dXxTivs&callback=initMap">
</script>
